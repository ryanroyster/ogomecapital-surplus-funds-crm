...
function normalize(d){
  const a=pickAuctionInfo(d),addr=d.address||d.propertyAddress||{},oi=d.ownerInfo||{};
  const address=typeof addr==="string"?addr:[addr.address,addr.street,addr.city,addr.state,addr.zip].filter(Boolean).join(", ");
