...
const server=http.createServer(async(req,res)=>{
  try{
    ...
    if(req.method==="GET"&&['/public/operations-domain.js','/public/operations-ui.js','/public/automation-domain.js','/public/automation-ui.js','/public/automation.css','/public/calendar-domain.js','/public/lead-colors.js','/public/lead-colors.css','/public/ogome-theme.js','/public/ogome-theme.css'].includes(u.pathname))return sendFile(res,path.join(ROOT,u.pathname.slice(1)));
